...
# %% auto 0
__all__ = ['normalize_df', 'standardize_df', 'heatmap_from_pkl', 'plot_novels', 'plot_histograms', 'ssms_from_pkl',
           'corr_heatmaps', 'corr_ts', 'lex_ts', 'plot_standardized']
...
def standardize_df(df):
    result = df.copy()
    for feature_name in df.columns:
        result[feature_name] = zscore(df[feature_name])
    return result
...
def heatmap_from_pkl(
    ...
    std: bool = False,  # flag to standardize, default is to `normalize`
...
# %% ../nbs/03_heatmaps_novels.ipynb 21
@call_parse
