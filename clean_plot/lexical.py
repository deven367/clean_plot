# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_lexical.ipynb.

# %% auto 0
__all__ = ['interpolate', 'load_pmi', 'load_dictionary', 'write_to_file_lexical', 'process_v2']

# %% ../nbs/03_lexical.ipynb 2
import re
from . import *
import os
import unidecode
...
# %% ../nbs/03_lexical.ipynb 6
def load_pmi(path):
    pmi = np.load(path)
    return pmi


# %% ../nbs/03_lexical.ipynb 7
def load_dictionary(path):
    fname = open(path, 'rb')
    data = pickle.load(fname)
    return data

# %% ../nbs/03_lexical.ipynb 8
